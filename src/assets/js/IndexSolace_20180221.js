    ...
    this.SetUI_R03 = function (binaryData) {
        try {            
            ...
            if (r03.ReturnType == 'O') {
                ...
                //iframeDynamicInfo.contentDocument.getElementById('T_DynamicData').innerHTML += '<tr> <td style="font-size: 14px; text-align: center">' + DealTime + '</td>'
                //        + '<td style="font-size: 14px; text-align: center">' + TradeType + Status + '</td>'
                //        + '<td style="font-size: 14px; text-align: center">' + TradeType + '</td>'
                //        + '<td style="font-size: 14px; text-align: center">' + BS + '</td>'
                //        + '<td style="font-size: 14px; text-align: center">' + cbID + '</td>'
                //        + '<td style="font-size: 14px; text-align: center">' + parseInt(r03.OrderPrice).toFixed(2) + '</td>'
                //        + '<td style="font-size: 14px; text-align: center">' + (r03.OrderLot) / 1000 + '</td>'
                //        + '<td style="font-size: 14px; text-align: center">' + r03.TradeAcno + '</td>'
                //    + '</tr>'

                //iframeDynamicInfo.contentDocument.getElementById('T_DynamicData').insertAdjacentHTML('afterend','<tr><td style="font-size: 14px; text-align: center">' + DealTime + '</td>'
                //       + '<td style="font-size: 14px; text-align: center">' + TradeType + Status + '</td>'
                //       + '<td style="font-size: 14px; text-align: center">' + TradeType + '</td>'
                //       + '<td style="font-size: 14px; text-align: center">' + BS + '</td>'
                //       + '<td style="font-size: 14px; text-align: center">' + cbID + '</td>'
